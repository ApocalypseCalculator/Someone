...
exports.execute = function (msg, args, client) {
    ...
    const msgembed = new Discord.MessageEmbed()
        ...
        .addField('Pings Received Counter Command', `${prefix}pingcount (alias ${prefix}pc)`, true)
        .addField('Global Ping Leaderboard', `${prefix}gleaderboard (alias ${prefix}glb)`, true)
        .addField('Server Ping Leaderboard', `${prefix}sleaderboard (alias ${prefix}slb)`, true)
